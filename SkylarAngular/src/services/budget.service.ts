...
export class BudgetService {
  ...
  createBudget(budget: { endDate: string; assignedProjectId: Project['id']; value: number; startDate: string }): Observable<Budget> {
  ...
  updateBudget(budget: { endDate: string; assignedProjectId: Project['id']; value: number; startDate: string },

...
export class BookingService {
  ...
  createBooking(booking: { date: string; assignedBankAccount: BankAccount[]; assignedProject: Project[]; assignedBudget: Budget[]; value: number; assignedUser: User[] }): Observable<Booking> {
  ...
  updateBooking(booking: { date: string; assignedBankAccount: BankAccount[]; assignedProject: Project[]; assignedBudget: Budget[]; value: number; assignedUser: User[] },
